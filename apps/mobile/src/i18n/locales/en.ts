...
const en = {
  ...
  receipt: {
    ...
    scanOffline: 'No connection, so the receipt could not be sent. Try again once you are back online.',
    scanTimeout: 'That took too long and was stopped. Try again — a shorter receipt reads faster.',
    scanFailedFile: 'Korb could not read that file. Try a different receipt, or add the items by hand.',
    ...
    paid: 'Paid',
    store: 'Shop',
    storeChange: 'Change the shop this receipt is from',
    storeTitle: 'Which shop?',
    storeUsed: 'You shop here',
    date: 'Date',
    dateChange: 'Change the date of this shop',
    dateTitle: 'When was this shop?',
    paidChange: 'Correct the total paid',
    discountChange: 'Correct the discounts',
    goods: 'Goods',
    deposit: 'Deposit',
    discount: 'Discounts',
    ...
    editPrice: 'Edit price per pack',
    editSize: 'Edit pack size',
    editPacks: 'Edit how many',
    lineTotal: 'Total',
    ...
    amended: { one: '%{count} purchase updated', other: '%{count} purchases updated' },
    saveChanges: 'Save changes',
    logging: { one: 'Logging %{count} line', other: 'Logging %{count} lines' },
    cannotReopen: 'This receipt was imported before Korb started keeping the scan, so there is nothing to edit. What it logged is still in your history.',
  ...
  receiptSource: {
    ...
    hint: 'Paper, a photo you already have, or the PDF the shop emailed.',
    cameraTitle: 'Scan it',
    cameraHint: 'Photograph the paper receipt',
    photosTitle: 'Choose a photo',
  ...
  purchaseSheet: {
    ...
    whenLabel: 'When you bought it',
    today: 'Today',
    yesterday: 'Yesterday',
    sizeLabel: 'Size of one pack',
    priceLabel: 'What it cost',
    storeLabel: 'Where you bought it',
    save: 'Save purchase',
    savedOn: '%{item} logged — %{when}',
  },
  receipts: {
    title: 'Receipts',
    cardHint: 'Tap one to fix a price or change what a line was matched to.',
    seeAll: 'See all',
    edited: 'Edited',
    didNotAddUp: 'Didn’t add up',
    openFor: 'Open the receipt from %{store}, %{date}',
    cannotReopen: 'cannot be edited',
    emptyTitle: 'No receipts yet',
    emptyBody: 'Scan one from a shopping list and it will be kept here, so you can come back and correct anything Korb read wrong.',
  },
  join: {
    ask: 'Ask to join',
    sentTitle: 'Request sent',
    sentBody: 'The owner of %{name} will see your request next time they open Korb. You’ll be in as soon as they approve it.',
    sentBodyGeneric: 'The household owner will see your request next time they open Korb.',
    queueTitle: { one: '%{count} person wants to join', other: '%{count} people want to join' },
    queueHint: 'They’ll see every list, every price and the whole shopping history.',
    wantsToJoin: 'Wants to join %{household}',
    ownerDecides: 'Owner decides',
    approveFor: 'Let %{name} in',
    declineFor: 'Turn down %{name}',
    approved: '%{name} is in.',
    declined: 'Turned down %{name}.',
    waitingTitle: 'Waiting to be let in',
    waitingUnseen: 'Sent. Nobody has opened Korb since you asked.',
    waitingSeen: 'Seen — waiting on a decision.',
    lapsed: 'This stood for two weeks with no answer. You can ask again.',
    withdraw: 'Withdraw',
    withdrawFor: 'Withdraw your request to join %{household}',
    withdrawn: 'Withdrew your request to join %{household}.',
  },
  staple: {
    badge: 'Staple',
  ...
  tips: {
    greens: 'Most greens keep longest unwashed in the fridge, in a bag with a dry paper towel.',
    tomato: 'Tomatoes lose their flavour in the fridge — a bowl on the counter suits them better.',
    potato: 'Potatoes want dark, cool and dry, and they sprout faster stored beside onions.',
    onion: 'Onions want somewhere dry and airy, and not the same basket as the potatoes.',
    mushroom: 'Mushrooms sweat in plastic; a paper bag in the fridge keeps them firm.',
    avocado: 'Ripen an avocado on the counter, then move it to the fridge to hold it there.',
    banana: 'Bananas ripen whatever is near them, so give them a spot of their own.',
    herbs: 'Treat soft herbs like flowers: stems in a glass of water, loosely covered.',
    carrot: 'Twist the tops off carrots before storing — the leaves keep drawing moisture.',
    citrus: 'Citrus stays juicy about twice as long in the fridge as it does in a bowl.',
    berries: 'Wash berries only as you eat them; damp ones go mouldy within a day.',
    apple: 'Apples keep for weeks in the fridge, and ripen everything stored beside them.',
    bread: 'Bread goes stale faster in the fridge — a bread bin or the freezer is kinder.',
    cheese: 'Cheese keeps better in paper than plastic; it needs to breathe a little.',
    butter: 'Butter takes on whatever it sits beside, so keep it wrapped and covered.',
    eggs: 'Pick one spot for eggs and leave them there; moving them in and out sweats the shell.',
    coffee: 'Coffee wants airtight and dark at room temperature, not the fridge or freezer.',
    chocolate: 'A cool cupboard suits chocolate; the fridge turns the surface chalky white.',
    honey: 'Honey never needs the fridge; cold turns it grainy and hard to spoon.',
    oil: 'Keep oil in a dark cupboard away from the hob; heat and light both turn it.',
    fish: 'Fresh fish belongs on the coldest shelf and on the same day\'s plate.',
  },
  status: {
  ...
  insights: {
    ...
    noneBoughtInRange: 'Nothing logged in this range. Try a longer one.',
  ...
  householdError: {
    ...
    updateApp: 'This version of Korb can’t join households any more. Update the app and try again.',
    requestGone: 'That request has already been dealt with.',
  },
};
