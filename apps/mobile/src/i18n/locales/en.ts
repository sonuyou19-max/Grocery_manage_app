...
const en = {
  ...
  plus: {
    ...
    detail: {
      historyTitle: 'A full year of history',
      historyBody: 'Spending, prices and habits going back 12 months instead of a few weeks.',
      movesTitle: 'Price changes',
      movesBody: '“Olive oil is 18% up on what you usually pay.” Korb watches so you don’t have to.',
      cheaperTitle: 'Cheaper elsewhere',
      cheaperBody: 'The same item compared across every shop you use, so you know where to buy it.',
      vibeTitle: 'Vibe Check',
      vibeBody: 'A ten-second sweep of everything running low, before you head out.',
      pantryMixTitle: 'Your pantry mix',
      pantryMixBody: 'What you actually keep in the house, by food group.',
      staplesTitle: 'Your staples',
      staplesBody: 'The things you buy again and again, ranked.',
      householdsTitle: 'Unlimited households',
      householdsBody: 'Home, the flat, your parents’ place — as many as you like.',
      recapTitle: 'Your weekly recap',
      recapBody: 'Your shopping week, written for you every Sunday.',
    },
  },
  paywall: {
    title: 'Korb Plus',
