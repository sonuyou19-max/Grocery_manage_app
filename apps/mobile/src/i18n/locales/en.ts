...
const en = {
  ...
  eco: {
    ...
    storesTitle: 'Where the light shops happen',
    storesHint: 'By score',
    storeScore: '%{score} / 100',
    storesNote: 'This compares what YOU buy at each shop, not the shops themselves.',
    swapsTitle: 'Worth a swap',
    swapsHint: 'From what you buy regularly',
    swapBody: 'A regular buy. %{to} is much lighter.',
    swapsNote: 'Suggestions, not instructions — and no kilos, because Korb rarely knows how much you bought.',
    swapTo: {
      chicken: 'Chicken or beans',
      softCheese: 'A soft cheese',
      oil: 'Olive oil',
      fish: 'Fish',
      oatMilk: 'Oat or soy milk',
      nuts: 'Nuts or dried fruit',
      tea: 'Tea',
    },
  },
  plus: {
    ...
    detail: {
      ...
      ecoBody: 'Your climate score week by week, which shops your lighter baskets happen at, and swaps drawn from what you actually buy.',
