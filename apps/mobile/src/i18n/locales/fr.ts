...
const fr = {
  ...
  plus: {
    ...
    detail: {
      historyTitle: 'Une année entière d’historique',
      historyBody: 'Dépenses, prix et habitudes sur 12 mois au lieu de quelques semaines.',
      movesTitle: 'Variations de prix',
      movesBody: '« L’huile d’olive est 18 % plus chère que d’habitude. » Korb surveille à ta place.',
      cheaperTitle: 'Moins cher ailleurs',
      cheaperBody: 'Le même produit comparé dans tous tes magasins, pour savoir où l’acheter.',
      vibeTitle: 'Vibe Check',
      vibeBody: 'Un balayage de dix secondes de tout ce qui manque, avant de partir.',
      pantryMixTitle: 'Ton équilibre de placard',
      pantryMixBody: 'Ce que tu as vraiment à la maison, par groupe alimentaire.',
      staplesTitle: 'Tes incontournables',
      staplesBody: 'Ce que tu rachètes encore et encore, classé.',
      householdsTitle: 'Foyers illimités',
      householdsBody: 'La maison, l’appart, chez tes parents — autant que tu veux.',
      recapTitle: 'Ton résumé hebdomadaire',
      recapBody: 'Ta semaine de courses, écrite pour toi chaque dimanche.',
    },
  },
  paywall: {
    title: 'Korb Plus',
