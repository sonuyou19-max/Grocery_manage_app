...
const fr = {
  ...
  eco: {
    ...
    basketExplainer: 'Compté par article, pas au poids. Le vert est léger pour le climat — légumes, pain, haricots. Le rouge est lourd — bœuf, fromage, beurre.',
    ...
    trendUp: 'Tes courses deviennent plus légères.',
    trendDown: 'Tes courses deviennent plus lourdes.',
  },
  create: {
  ...
  plus: {
    ...
    detail: {
      ...
      ecoTitle: 'Vois tes courses s’alléger',
