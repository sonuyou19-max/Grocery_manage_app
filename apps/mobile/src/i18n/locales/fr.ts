...
const fr = {
  ...
  receipt: {
    ...
    scanOffline: 'Pas de connexion, le ticket n’a pas pu être envoyé. Réessaie une fois de retour en ligne.',
    scanTimeout: 'Cela a pris trop de temps et a été interrompu. Réessaie — un ticket plus court se lit plus vite.',
    scanFailedFile: 'Korb n’a pas pu lire ce fichier. Essaie un autre ticket, ou saisis les articles à la main.',
  ...
  receiptSource: {
    ...
    hint: 'Papier, une photo que tu as déjà, ou le PDF envoyé par le magasin.',
    cameraTitle: 'Le photographier',
    cameraHint: 'Prendre le ticket papier en photo',
    photosTitle: 'Choisir une photo',
    ...
    chosenHint: 'Touchez une photo pour la retirer.',
  ...
  pantry: {
    ...
    stillGoodToast: {
      one: '%{item} — noté, on redemande dans %{count} jour',
      other: '%{item} — noté, on redemande dans %{count} jours',
    },
  },
  category: {
