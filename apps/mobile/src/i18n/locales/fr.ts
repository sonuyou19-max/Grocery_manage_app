...
const fr = {
  ...
  eco: {
    ...
    storesTitle: 'Où se font les courses légères',
    storesHint: 'Par score',
    storeScore: '%{score} / 100',
    storesNote: 'On compare ce que TU achètes dans chaque magasin, pas les magasins.',
    swapsTitle: 'Un échange à tenter',
    swapsHint: 'D\'après ce que tu achètes souvent',
    swapBody: 'Un achat régulier. %{to}, c’est bien plus léger.',
    swapsNote: 'Des suggestions, pas des consignes — et pas de kilos, car Korb connaît rarement les quantités.',
    swapTo: {
      chicken: 'Poulet ou haricots',
      softCheese: 'Un fromage frais',
      oil: 'Huile d\'olive',
      fish: 'Poisson',
      oatMilk: 'Boisson avoine ou soja',
      nuts: 'Noix ou fruits secs',
      tea: 'Thé',
    },
  },
  plus: {
    ...
    detail: {
      ...
      ecoBody: 'Ton score climat semaine après semaine, les magasins où tes paniers sont les plus légers, et des échanges tirés de tes vrais achats.',
