...
const de = {
  ...
  receipt: {
    ...
    deposit: 'Pfand',
    discount: 'Rabatte',
    matchedCount: 'Deiner Liste zugeordnet',
    matchedHow: 'Auf deiner Liste (%{how})',
    ambiguous: 'Mehrere Einträge deiner Liste kämen infrage',
    unmatched: 'Nicht auf deiner Liste',
  },
  coach: {
    gotIt: 'Alles klar',
