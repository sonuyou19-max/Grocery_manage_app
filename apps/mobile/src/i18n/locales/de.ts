...
const de = {
  ...
  receipt: {
    ...
    scanOffline: 'Keine Verbindung, der Bon konnte nicht gesendet werden. Versuch es erneut, sobald du wieder online bist.',
    scanTimeout: 'Das hat zu lange gedauert und wurde abgebrochen. Versuch es noch mal — ein kürzerer Bon geht schneller.',
    scanFailedFile: 'Korb konnte diese Datei nicht lesen. Versuch einen anderen Bon oder trag die Artikel von Hand ein.',
    ...
    paid: 'Bezahlt',
    store: 'Geschäft',
    storeChange: 'Geschäft dieses Kassenbons ändern',
    storeTitle: 'Welches Geschäft?',
    storeUsed: 'Hier kaufst du ein',
    date: 'Datum',
    dateChange: 'Datum dieses Einkaufs ändern',
    dateTitle: 'Wann war dieser Einkauf?',
    paidChange: 'Gezahlten Betrag korrigieren',
    discountChange: 'Rabatte korrigieren',
    goods: 'Waren',
    deposit: 'Pfand',
    discount: 'Rabatte',
    ...
    editPrice: 'Preis pro Packung ändern',
    editSize: 'Packungsgröße ändern',
    editPacks: 'Anzahl ändern',
    lineTotal: 'Gesamt',
    ...
    amended: { one: '%{count} Einkauf aktualisiert', other: '%{count} Einkäufe aktualisiert' },
    saveChanges: 'Änderungen speichern',
    logging: { one: '%{count} Position wird erfasst', other: '%{count} Positionen werden erfasst' },
    cannotReopen: 'Dieser Kassenbon wurde importiert, bevor Korb den Scan aufbewahrt hat — es gibt nichts zu bearbeiten. Das Erfasste bleibt in deinem Verlauf.',
  ...
  receiptSource: {
    ...
    hint: 'Papier, ein vorhandenes Foto oder das PDF vom Laden.',
    cameraTitle: 'Abfotografieren',
    cameraHint: 'Den Papierbon aufnehmen',
    photosTitle: 'Foto auswählen',
  ...
  purchaseSheet: {
    ...
    whenLabel: 'Wann gekauft',
    today: 'Heute',
    yesterday: 'Gestern',
    sizeLabel: 'Größe einer Packung',
    priceLabel: 'Was es gekostet hat',
    storeLabel: 'Wo gekauft',
    save: 'Einkauf speichern',
    savedOn: '%{item} erfasst — %{when}',
  },
  receipts: {
    title: 'Kassenbons',
    cardHint: 'Tippe auf einen, um einen Preis zu korrigieren oder eine Zuordnung zu ändern.',
    seeAll: 'Alle ansehen',
    edited: 'Bearbeitet',
    didNotAddUp: 'Ging nicht auf',
    openFor: 'Kassenbon von %{store}, %{date} öffnen',
    cannotReopen: 'nicht bearbeitbar',
    emptyTitle: 'Noch keine Kassenbons',
    emptyBody: 'Scanne einen aus einer Einkaufsliste heraus — er wird hier aufbewahrt, damit du später korrigieren kannst, was Korb falsch gelesen hat.',
  },
  join: {
    ask: 'Beitritt anfragen',
    sentTitle: 'Anfrage gesendet',
    sentBody: 'Der Besitzer von %{name} sieht deine Anfrage beim nächsten Öffnen von Korb. Sobald sie bestätigt wird, bist du dabei.',
    sentBodyGeneric: 'Der Haushaltsbesitzer sieht deine Anfrage beim nächsten Öffnen von Korb.',
    queueTitle: { one: '%{count} Person möchte beitreten', other: '%{count} Personen möchten beitreten' },
    queueHint: 'Sie sehen dann jede Liste, jeden Preis und den gesamten Einkaufsverlauf.',
    wantsToJoin: 'Möchte %{household} beitreten',
    ownerDecides: 'Besitzer entscheidet',
    approveFor: '%{name} hereinlassen',
    declineFor: '%{name} ablehnen',
    approved: '%{name} ist dabei.',
    declined: '%{name} abgelehnt.',
    waitingTitle: 'Warten auf Freigabe',
    waitingUnseen: 'Gesendet. Seit deiner Anfrage hat niemand Korb geöffnet.',
    waitingSeen: 'Gesehen — Entscheidung steht aus.',
    lapsed: 'Die Anfrage stand zwei Wochen ohne Antwort. Du kannst erneut fragen.',
    withdraw: 'Zurückziehen',
    withdrawFor: 'Anfrage für %{household} zurückziehen',
    withdrawn: 'Anfrage für %{household} zurückgezogen.',
  },
  staple: {
    badge: 'Basis',
    ...
    actionStopped: 'Nicht mehr kaufen',
  ...
  pantry: {
    ...
    stillGoodToast: {
      one: '%{item} — notiert, wir fragen in %{count} Tag wieder',
      other: '%{item} — notiert, wir fragen in %{count} Tagen wieder',
    },
  },
  category: {
  ...
  insights: {
    ...
    noneBoughtInRange: 'In diesem Zeitraum nichts erfasst. Versuch einen längeren.',
  ...
  householdError: {
    ...
    updateApp: 'Diese Korb-Version kann Haushalten nicht mehr beitreten. Aktualisiere die App und versuche es erneut.',
    requestGone: 'Diese Anfrage wurde bereits bearbeitet.',
  },
};
