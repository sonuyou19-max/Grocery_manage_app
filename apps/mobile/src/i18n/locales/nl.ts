...
const nl = {
  ...
  receipt: {
    ...
    deposit: 'Statiegeld',
    discount: 'Kortingen',
    matchedCount: 'Gekoppeld aan je lijst',
    matchedHow: 'Op je lijst (%{how})',
    ambiguous: 'Meerdere artikelen op je lijst zouden dit kunnen zijn',
    unmatched: 'Niet op je lijst',
  },
  coach: {
    gotIt: 'Duidelijk',
