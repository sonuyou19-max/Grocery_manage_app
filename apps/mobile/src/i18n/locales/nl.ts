...
const nl = {
  ...
  plus: {
    ...
    detail: {
      historyTitle: 'Een heel jaar geschiedenis',
      historyBody: 'Uitgaven, prijzen en gewoontes van 12 maanden terug in plaats van een paar weken.',
      movesTitle: 'Prijsveranderingen',
      movesBody: '“Olijfolie is 18% duurder dan je normaal betaalt.” Korb let op, jij niet.',
      cheaperTitle: 'Elders goedkoper',
      cheaperBody: 'Hetzelfde product vergeleken bij al je winkels, zodat je weet waar je moet zijn.',
      vibeTitle: 'Vibe Check',
      vibeBody: 'In tien seconden zien wat bijna op is, voor je de deur uit gaat.',
      pantryMixTitle: 'Je voorraadmix',
      pantryMixBody: 'Wat je echt in huis hebt, per voedingsgroep.',
      staplesTitle: 'Je vaste boodschappen',
      staplesBody: 'De dingen die je steeds opnieuw koopt, op volgorde.',
      householdsTitle: 'Onbeperkt huishoudens',
      householdsBody: 'Thuis, het appartement, bij je ouders — zoveel je wilt.',
      recapTitle: 'Je wekelijkse terugblik',
      recapBody: 'Je boodschappenweek, elke zondag voor je geschreven.',
    },
  },
  paywall: {
    title: 'Korb Plus',
