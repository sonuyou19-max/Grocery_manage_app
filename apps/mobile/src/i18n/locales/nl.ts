...
const nl = {
  ...
  eco: {
    ...
    storesTitle: 'Waar de lichte boodschappen gebeuren',
    storesHint: 'Op score',
    storeScore: '%{score} / 100',
    storesNote: 'Dit vergelijkt wat JIJ bij elke winkel koopt, niet de winkels zelf.',
    swapsTitle: 'Een ruil waard',
    swapsHint: 'Uit wat je vaak koopt',
    swapBody: 'Koop je regelmatig. %{to} is veel lichter.',
    swapsNote: 'Suggesties, geen voorschriften — en geen kilo’s, want Korb weet zelden hoeveel je kocht.',
    swapTo: {
      chicken: 'Kip of bonen',
      softCheese: 'Een zachte kaas',
      oil: 'Olijfolie',
      fish: 'Vis',
      oatMilk: 'Haver- of sojadrink',
      nuts: 'Noten of gedroogd fruit',
      tea: 'Thee',
    },
  },
  plus: {
    ...
    detail: {
      ...
      ecoBody: 'Je klimaatscore week na week, bij welke winkels je lichtste manden ontstaan, en ruilideeën uit wat je echt koopt.',
