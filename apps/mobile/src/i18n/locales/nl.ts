...
const nl = {
  ...
  plus: {
    ...
    trialEndingBody: 'Daarna houd je alles behalve het lange overzicht — een jaar geschiedenis, prijsveranderingen en je wekelijkse terugblik. Er wordt niets verwijderd.',
  },
  paywall: {
    title: 'Korb Plus',
